...
namespace TimeTracking.Data.Migrations
{
    ...
    [Migration("20230107164625_AddedHoursPerDay")]
    partial class AddedHoursPerDay
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TimeTracking.Models.Customer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("TEXT");
            ...
            modelBuilder.Entity("TimeTracking.Models.TimeSheetRow", b =>
                {
                    ...
                    b.Property<Dictionary<DayOfWeek, TimeSpan>>("HoursPerday")
                        .IsRequired()
                        .HasColumnType("json");
            ...
            modelBuilder.Entity("TimeTracking.Models.Project", b =>
                {
                    b.HasOne("TimeTracking.Models.Customer", "Customer")
                        .WithMany()
